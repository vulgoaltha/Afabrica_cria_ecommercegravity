            ...
            <div className="min-h-screen bg-black pt-24 pb-16 flex items-center justify-center">
                ...
                >
                    ...
                    <Button
                        asChild
                        size="lg"
                        className="bg-[var(--color-gold)] hover:bg-yellow-500 text-black font-semibold"
                    >
                        <Link href="/catalogo">
        ...
        <div className="min-h-screen bg-black pt-24 pb-16">
            <div className="container mx-auto px-4">
                ...
                >
                    <Link
                        href="/catalogo"
                        className="inline-flex items-center text-gray-400 hover:text-[var(--color-gold)] transition-colors mb-6"
                    >
                        <ArrowLeft className="w-5 h-5 mr-1" />
                        Continuar Comprando
                    </Link>
                    <h1 className="text-4xl md:text-5xl font-bold">
                        Seu <span className="text-[var(--color-gold)]">Carrinho</span>
                    </h1>
                </motion.div>
                    ...
                    <div className="lg:col-span-2 space-y-4">
                        {cartItems.map((item, index) => (
                            <motion.div
                                ...
                                className="bg-gray-900/50 border border-gray-800 rounded-xl p-6 hover:border-[var(--color-gold)]/50 transition-all duration-300"
                            >
                                <div className="flex gap-6">
                                    ...
                                    <div className="flex-1 space-y-3">
                                        <div>
                                            <Link
                                                href={`/product/${item.product.id}`}
                                                className="text-xl font-semibold hover:text-[var(--color-gold)] transition-colors"
                                            >
                                                {item.product.title}
                                            </Link>
                                        ...
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center gap-3">
                                                <button
                                                    ...
                                                    className="w-8 h-8 rounded-lg border border-gray-700 hover:border-[var(--color-gold)] flex items-center justify-center transition-colors"
                                                >
                    ...
                    >
                        <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-6 sticky top-24 space-y-6">
                            ...
                            <Button
                                asChild
                                size="lg"
                                className="w-full bg-[var(--color-gold)] hover:bg-yellow-500 text-black font-semibold text-lg py-6"
                            >
