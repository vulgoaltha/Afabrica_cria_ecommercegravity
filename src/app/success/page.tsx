    ...
    return (
        <div className="min-h-screen bg-black pt-24 flex items-center justify-center p-4">
            ...
            >
                ...
                <h1 className="text-3xl md:text-4xl font-bold text-white mb-4 uppercase tracking-tighter">
                    Pedido Confirmado!
                </h1>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <Button
                        asChild
                        size="lg"
                        className="bg-[var(--color-gold)] hover:bg-yellow-500 text-black font-bold text-lg py-6 uppercase tracking-wider rounded-xl"
                    >
                        <Link href="/">
                            Voltar ao Início
                        </Link>
                    ...
                    <Button
                        ...
                        size="lg"
                        variant="outline"
                        className="border-gray-700 text-white hover:bg-white/10 text-lg py-6 uppercase tracking-wider rounded-xl bg-transparent"
                    >
                        <Link href="/catalogo">
